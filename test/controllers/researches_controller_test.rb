...
class ResearchesControllerTest < ActionController::TestCase
  ...
  test "should create research" do
    assert_difference('Research.count') do
      post :create, research: { rauthor: @research.rauthor, rbody: @research.rbody, rextra: @research.rextra, rid: @research.rid, rimage: @research.rimage, rlink: @research.rlink, rname: @research.rname, slug: @research.slug }
    end
  ...
  test "should update research" do
    patch :update, id: @research, research: { rauthor: @research.rauthor, rbody: @research.rbody, rextra: @research.rextra, rid: @research.rid, rimage: @research.rimage, rlink: @research.rlink, rname: @research.rname, slug: @research.slug }
    assert_redirected_to research_path(assigns(:research))
  end
